...
class Channel (internal var nameOrga:String,internal var channel_name: String) {

    private var userList = mutableListOf<User>()
    private var descriptionChannel : String = ""
    private var public:Boolean = true

    constructor(nameOrga:String,channel_name: String,public: Boolean,desc: String) : this(nameOrga,channel_name){
